...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/duzhongjieqiji@163.com/KingfisherWebPP'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'duzhongjieqiji@163.com' => 'qiji@ksjgs.com' }
  s.source           = { :git => 'https://github.com/duzhongjieqiji@163.com/KingfisherWebPP.git', :tag => s.version.to_s }
